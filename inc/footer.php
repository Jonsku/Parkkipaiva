    ...
    <!-- footer starts -->
    <div id="footer"><img src="<?php echo $config['paths']['base_url'] ?>/images/footer-temp.gif" width="868" height="72" border="0" usemap="#Map">
            <map name="Map">
              ...
              <area shape="rect" coords="637,55,841,69" href="mailto:kirsi-leena.helle@ilmastoinfo.fi" alt="Kirsi-Leena">
