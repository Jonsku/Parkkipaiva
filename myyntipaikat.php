      ...
      <div class="container">
        <div class="row" id="login_row">
          <div class="span12 inset">
            ...
            <br/><br/>
            <a name="login"><button id="logout-btn" class="btn-red"><?php s('en_EN'); ?>Log out<?php e(); ?></button><button id="email-login-select" class="btn-red login-btn"><?php s('en_EN'); ?>Login with an email address<?php e(); ?></button><button id="fb-login" class="btn-red login-btn"><?php s('en_EN'); ?>Login with a facebook account<?php e(); ?></button><button id="create-stand-btn" class="btn-red">Lisää myyntipaikka</button><button id="create-recycle-btn" class="btn-red">Lisää kierrätyspiste</button></a><span id="contact-fb-msg"><?php s('en_EN'); ?>Contacting facebook...<?php e(); ?></span><span id="check-fb-msg"><?php s('en_EN'); ?>Checking if you're logged in...<?php e(); ?></span><span id="no-fb-msg"><?php s('en_EN'); ?>Facebook is not responding...<?php e(); ?></span>
                      ...
                      <div class="row">
                        ...
                        <div class="span6">
                          ...
                          <div class="control-group">
                              ...
                              <div class="control-group">
                              <label class="control-label"><?php s('en_EN'); ?>How many parking slots will you occupy?<?php e(); ?> *</label>
                              <div class="controls">
